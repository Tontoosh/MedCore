      ...
      <div className="p-8 max-w-4xl">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-slate-500 text-sm mt-0.5">Нийт {mockCases.length} тохиолдол</p>
          </div>
          <Link
            href="/cases/new"
          ...
          {mockCases.map((c) => {
            ...
            return (
              <Link
                key={c.id}
                href={href}
                className="flex items-center gap-4 bg-white rounded-xl border border-slate-100 p-5 hover:border-blue-200 hover:shadow-sm transition group"
              >
